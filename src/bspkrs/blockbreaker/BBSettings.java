...
public final class BBSettings
{
    ...
    public final static String blocksDesc           = "Block List, \";\" splits blocks and \",\" splits block ID and metadata.";
    public static String       blocks               = "17;";
    public final static String dropsDesc            = "Item drops values: 0-No drops. 1-Drops in Survival. 2-Drops in Survival & Creative. 3-Drops in Survival, Creative, & Adventure";
    ...
    public final static String blocksPerTickDesc    = "Maximum number of blocks to be removed per game tick (1/20 seconds). Using a low number will keep the game from getting huge" +
                                                            "performance drops but also decreases the speed at which things are destroyed.";
    ...
    public static void loadConfig(Configuration config)
    {
        ...
        blocks = Config.getString(config, "blocks", ctgyGen, blocks, blocksDesc);
        drops = Config.getInt(config, "drops", ctgyGen, drops, 0, 3, dropsDesc);
        ...
        if (blockGroups == null)
            blockGroups = CommonUtils.stringToGroups(blocks);
    }
}
